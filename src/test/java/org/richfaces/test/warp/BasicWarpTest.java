...
import org.richfaces.test.graphene.TestingServlet;
...
public class BasicWarpTest {
    ...
    public static WebArchive createDeployment() {
        ...
        return ShrinkWrap.create(WebArchive.class, "test.war").addClass(TestingServlet.class)
                .addAsWebResource(new File("src/main/webapp/basicWarpTest.html"));
    }
    ...
    public void test() {
        ...
        Warp.execute(new ClientAction() {
            public void action() {
                browser.navigate().to(contextPath + "basicWarpTest.html");
            }
